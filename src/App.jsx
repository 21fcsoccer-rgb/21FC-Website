  ...
  const Header = () => (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        <img
          src={BASE + "images/logo-court-baller-white.png"}
          alt="21FC Logo"
  ...
  const Schedule = () => (
    <section
      ...
      style={{
        ...
        backgroundImage: `url(${BASE}images/DSC08674.jpg)`,
    ...
    >
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          {[
            BASE + 'images/DSC08584.jpg',
            BASE + 'images/DSC08634.jpg',
            BASE + 'images/DSC08703.jpg',
            BASE + 'images/DSC08730.jpg',
            BASE + 'images/DSC08806.jpg',
            BASE + 'images/DSC08820.jpg',
          ].map((src, idx) => (
            <div
              key={idx}
              style={{
