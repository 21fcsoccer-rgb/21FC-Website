...
const Hero = () => {
  ...
  return (
    <section id="hero" style={{
      ...
      {/* Parallax Photo Background - moves slower than scroll */}
      <div style={{
        position: "absolute", inset: "-30% 0",
        backgroundImage: `url(${PHOTOS.heroGreen})`,
        ...
        <img src={PHOTOS.heroGreen} alt="" style={{ display: "none" }} onLoad={() => setImgLoaded(true)} />
      </div>
